...
function PopUp({condition , msg , setCondition}) {
  return (
    <div className={`absolute w-full h-[200px] bg-white z-10 flex flex-col shadow-lg rounded-xl transition-all duration-1000 ${condition ? 'translate-y-0' : '-translate-y-[500px]'}`}>
