...
function MenuHistory({
    ...
    return (
        <div
            className={`h-[100vh] w-[400px] pl-[29px] pr-[40px] bg-white shadow-lg border transition-all duration-500 fixed right-0 ${
                openSide
        ...
        >
            ...
            <div
                ...
                className="w-[70px] h-[70px] shadow-lg bg-[#7D5E42] text-white rounded-full absolute -left-10 top-1/2 cursor-pointer z-10 text-2xl flex justify-center items-center"
            >
                {"<"}
            </div>
            ...
            <div className="w-[350px] h-fit bg-[#FFFFFF] shadow-lg border mt-[20px] rounded-[20px]">
                ...
                <div className="mb-[20px] mx-[20px] h-[50px] mt-[20px] flex gap-3 justify-center">
                    <button
                        ...
                        className="flex-1 border-2 rounded-[18px]  font-bold"
                    >
                        Nanti
                    </button>
                    <button
                        onClick={handleSubmit}
                        className="flex-1 rounded-[18px] font-bold text-white bg-[#7D5E42]"
                    >
                        Bayar
                    </button>
                </div>
